...
const Footer = () => {
  return (
    <div
      className="fixed h-8 bottom-0 px-2 flex items-center justify-center w-full text-xs text-gray-500 "
      style={{ paddingTop: "1.25rem", paddingBottom: "0.25rem" }}
    >
      <span>
        Built with{" "}
        <svg
        ...
        by{" "}
        <a
          href="www.linkedin.com/in/yakashkumar"
          target="__blank"
